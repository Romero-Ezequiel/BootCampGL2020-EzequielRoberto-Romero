...
public class ProyectoEmpleados {
    ...
    public static void main(String[] args) throws IOException {
	    ...
	    //calcular el empleado que mas cobra por horas extra
	...
	for (i = 1; i <= N; i++) {
	    ...
	    empleados[indice] = e; //se el empleado al array
	    indice++;
	}
    }
    ...
    //metodo para pedir el importe de la hora extra
    ...
    //metodo que devuelve el numero total de empleados
    public static int numeroDeEmpleados() {
	return indice;
    }

    //metodo que devuelve el empleado que mas cobra
    ...
    //metodo que devuelve el empleado que menos cobra
    ...
    //metodo que devuelve el empleado que mas cobra por horas extra
    ...
    //metodo que devuelve el empleado que menos cobra por horas extra
    ...
    //metodo para ordenar todos los empleados por su salario de menor a mayor
    ...
    //metodo para mostrar los datos de cada empleado junto con su sueldo
