...
insert into animales(id, nombre, especie, peso) values(11,'Lala','Gato',10.3);
insert into animales(id, nombre, especie, peso) values(12,'Lola','Pero',50.3);
insert into animales(id, nombre, especie, peso) values(13,'Lele','Gato',10.3);
insert into animales(id, nombre, especie, peso) values(14,'Lulu','Gato',11.3);
insert into animales(id, nombre, especie, peso) values(15,'lili','Gato',10.3);

select * from animales where nombre like 'L%' or nombre like 'l%' order by id asc;
